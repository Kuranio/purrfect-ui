// Código para importar el botón
export const importCode = `import { Button } from "@purrfect-ui/components";`;

// Uso básico del componente Button
export const basicUsageCode = `import React, { useState } from 'react';
...
export const UsageCode = `import React from "react";
import { Button } from "@purrfect-ui/components";

export function ExampleButton() {
  return (
    <Button 
      href="/components/background" 
      content="This is a button example" 
    />
  );
}
